    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/leave/approve", "/leaves/reject").hasAuthority("ROLE_ADMIN")
                        .requestMatchers("/holidays/**").hasAuthority("ROLE_ADMIN")
                ...
                .formLogin(form -> form
                        ...
                        .permitAll()  // Allowing all users to access the login page
                )
